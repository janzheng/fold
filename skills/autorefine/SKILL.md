---
name: autorefine
description: Autonomous refinement loop — agent and user agree on what "better" means, then the agent iterates (modify → compare → keep/discard → repeat) until quality converges. Use when the user says "autorefine", "refine this", "make this better", "iterate on this", "keep improving", "optimize this", or wants an autonomous improvement loop on code, docs, skills, or any artifact.
---
